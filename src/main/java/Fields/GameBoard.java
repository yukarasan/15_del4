...
public class GameBoard {
    ...
    private void createOwnableField() {
        ...
        ownableField.setFields(fields,9, 2400,Color.orange,"Allegade","Navn:Allegade,pris:2400, pris per hus:1.000 DKK, pris per hotel:1.000 DKK+4 huse, leje af grund:150 DKK, med 1 hus:800, med 2 huse: 2.000 DKK, med 3 huse: 6.000 DKK, med 4 huse: 9.000 DKK,med 1 hotel: 12.000 DKK, pantsætningsværdi: 1.200 DKK ");
        ownableField.setFields(fields,11,2400,Color.yellow,"Frederiksberg Allé","Navn: Frederiksberg, Pris: 2.800 DKK, pris per hus: 2.000 DKK, pris per hotel: 2000 DKK+ 4 huse, leje af grund: 200 DKK, med 1 hus:1.000 DKK, med 2 huse: 3.000 DKK, med 3 huse: 9.000 DKK, med 4 huse: 12.500, med 1 hotel, pantsætningsværdi: 1.400 DKK");
        ...
        ownableField.setFields(fields,16,3600,Color.gray,"Bernstorffsvej","Navn Bernstorffsvej, Pris: 3600 DKK,Pris per hus: 2.000 DKK, pris per hotel: 2.000 DKK+4 huse,Leje af grund: 300 DKK m/ 1 hus: 1.400 DKK m/ 2 huse: 4.000 DKK m/ 3 huse: 11.000 DKK m/4 huse: 15.000 DKK m/ hotel: 19.000 DKK Pantværdi: 1.800 DKK ");
